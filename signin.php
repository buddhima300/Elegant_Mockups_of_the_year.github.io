            ...
            <section>
                <div class="menubar">
                    ...
                    <ul>
                        ...
                        <li  class="active"><i class="fa fa-user-circle"></i><a href="#">PROFILE</a>
                            <div class="submenu-1">
                                <ul>
    ...
    <main>
        <div class="bg">
            <div class="signup-container">
                ...
                <div class="form-card">
                    <form action="login.php" method="POST" name="logform" onsubmit="return(signin_validate())" class="reg-form">
    
                        <label for="usernameemail">EMAIL</label>
                        <input type="email" name="usernameemail" id="signinemail" require placeholder="email">
    
                        <label for="username">PASSWORD</label>
                        <input type="password" name="logpassword" id="signinpassword" require placeholder="Password">
